...
int rdma_qp_to_rtr(struct rdma_resource* res,const rdma_connection_info *local,const rdma_connection_info *remote,uint8_t port_num);// ready to receive state
